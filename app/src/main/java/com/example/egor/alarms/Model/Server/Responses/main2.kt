...
fun main(args: Array<String>) {
    ...
    val loginResponse = LoginResponse(logged = true, id = 0)
    val registerResponse = RegisterResponse(id = 0, registred = true)
    ...
    val isRequestToRoomAcceptedResponse = IsRequestToRoomSentResponse(sent = true, roomId = 1)
